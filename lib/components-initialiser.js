...
import { CheckboxCollapseComponent } from './components/checkbox-collapse';
...
export class ComponentsInitialiser {
  ...
  initialise() {
    ...
    this.checkboxGroups = [];
    $('[data-checkbox-group]').each((i, o) => {
      const checkboxGroup = new CheckboxGroupComponent(o);
      this.checkboxGroups.push(checkboxGroup);
    });

    this.checkboxCollapses = [];
    $('[data-checkbox-collapse]').each((i, o) => {
      const checkboxCollapse = new CheckboxCollapseComponent(o);
      this.checkboxCollapses.push(checkboxCollapse);
    });
