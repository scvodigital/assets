...
export class MapClusteredComponent {
    constructor(mapContainer) {
        ...
        const initialZoom = this.oldZoom = this.options.zoom || 7;
        ...
        const PADDING = 0.25; // How far outside the bounds shown do we get results?
        ...
        var loadMarkers = (thenFunction) => {
            ...
            this.queryBounds = this.map.getBounds().pad(PADDING);
            this.options.query.ne_lat = this.queryBounds._northEast.lat;
            this.options.query.ne_lon = this.queryBounds._northEast.lng;
            this.options.query.sw_lat = this.queryBounds._southWest.lat;
            this.options.query.sw_lon = this.queryBounds._southWest.lng;
